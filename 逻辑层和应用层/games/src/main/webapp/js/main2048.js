...
$(document).keydown(function( event ){
	...
	sumPoint ++;
	var cha = tagPoint-sumPoint;
	updateStep(cha);
	if(setGameOver(tagPoint)){
		...
		// send grade
		var accoundId = "1.2.2617";
		sendpersonGradinfor(accoundId,score);
	}
});
...
/*提交成绩*/
function sendpersonGradinfor(accountIdOrName,grade){
        $.ajax({
            type:"POST",
            url:"com.servlet/PersonGrad",
            data:{
                grade:grade
            },
            success:function(data){
                alert("you have successfully get money");
                deleteGradinfor();
...
function deleteGradinfor(){
        $.ajax({
            type:"POST",
            url:"com.servlet/DeleteServer",
            data:{
            },
            success:function(data){
                alert("you have successfully delete money");         
            }
        });
}
